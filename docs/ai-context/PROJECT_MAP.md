...
| Fixture/snapshot drift: `tests/__snapshots__/guardian-report.md`, `tests/actionableGuidance.test.ts`, `tests/analyzerAccuracy.integration.test.ts` | Fixtures and expected output can drift from generated map behavior. | npm run build |
